...
<%
    ...
    String shenhejieguo = request.getParameter("shenhejieguo");//审核结果
	...
	String sql = "update demandinfo set shenhexs = '"+ shenhejieguo +"',guishubumen ='"+tijiaobumen+"',xsshenheyijian = '"+ shenheyijian +"' where demandnumber =" + demandid;
	...
	if (i == 1)
	{
		...
		response.setHeader("refresh", "1;url=suoyou.jsp");
		}
		else
		{
